...
const activityRecords = [
  ...
  { id: "a4", title: "Sunset Catamaran Cruise", category: "Catamaran Cruises", region: "Manuel Antonio", price: 89, duration: "4 hrs", level: "Easy", bestFor: ["Couples", "Family", "Groups"], private: true, family: true, operatorId: "op4", confirm: false, rating: 4.9, reviews: 342, desc: "Snorkeling, open bar, and a golden-hour sail along the Pacific coastline.", included: ["Open bar & lunch", "Snorkel gear", "Onboard guide", "Hotel pickup"], bring: ["Swimsuit", "Towel", "Sunscreen (reef-safe)"] },
  { id: "a5", title: "Reef Snorkeling Tour", category: "Snorkeling", region: "Uvita", price: 75, duration: "3 hrs", level: "Easy", bestFor: ["Family", "Couples"], private: false, family: true, operatorId: "op4", confirm: false, rating: 4.7, reviews: 98, desc: "Explore the protected waters of Marino Ballena with a marine-life guide.", included: ["Boat & guide", "Snorkel gear", "Fresh fruit & water"], bring: ["Swimsuit", "Reef-safe sunscreen", "Towel"] },
  { id: "a6", title: "Beginner Surf Lesson", category: "Surf Lessons", region: "Tamarindo", price: 65, duration: "2 hrs", level: "Easy", bestFor: ["Family", "Couples", "Groups"], private: true, family: true, operatorId: "op3", confirm: false, rating: 4.9, reviews: 187, desc: "Stand up on your first wave with certified instructors on Tamarindo's gentle breaks.", included: ["Board & rash guard", "Certified instructor", "Beach photos"], bring: ["Swimsuit", "Sunscreen", "Water"] },
  { id: "a7", title: "Rainforest Zipline & Canopy", category: "Ziplining", region: "Manuel Antonio", price: 85, duration: "3.5 hrs", level: "Moderate", bestFor: ["Family", "Groups", "Adventure"], private: false, family: true, operatorId: "op2", confirm: false, rating: 4.8, reviews: 276, desc: "Twelve cables, a Tarzan swing, and treetop views over the rainforest canopy.", included: ["All safety gear", "Certified guides", "Hotel transfer"], bring: ["Closed shoes", "Light clothing"] },
  { id: "a8", title: "Wildlife Night Walk", category: "Wildlife Night Tours", region: "Manuel Antonio", price: 55, duration: "2 hrs", level: "Easy", bestFor: ["Family", "Couples", "Wildlife"], private: false, family: true, operatorId: "op2", confirm: false, rating: 4.7, reviews: 142, desc: "Spot sloths, frogs, snakes, and nocturnal life with a naturalist and night optics.", included: ["Naturalist guide", "Flashlights", "Entrance fees"], bring: ["Closed shoes", "Bug spray", "Light rain jacket"] },
  { id: "a9", title: "Whale & Dolphin Watching", category: "Whale & Dolphin Watching", region: "Uvita", price: 95, duration: "3.5 hrs", level: "Easy", bestFor: ["Family", "Couples"], private: false, family: true, operatorId: "op4", confirm: true, rating: 4.8, reviews: 119, desc: "Seasonal humpback whales and resident dolphins in Costa Rica's first marine park.", included: ["Boat & marine guide", "Life jackets", "Fruit & water"], bring: ["Camera", "Hat", "Sunscreen"] },
...
export const regions = [
  ...
  { name: "Quepos", tag: "Sport fishing capital", gradKey: "ocean" },
  { name: "Uvita", tag: "Whales & waterfalls", gradKey: "reef" },
  { name: "Dominical", tag: "Surf & jungle", gradKey: "jungle" },
  { name: "Jacó", tag: "Adventure & nightlife", gradKey: "sunset" },
  { name: "Tamarindo", tag: "Surf town energy", gradKey: "gold" },
  { name: "Guanacaste", tag: "Luxury & dry forest", gradKey: "ocean" },
];
