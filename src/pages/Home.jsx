            ...
            <Reveal>
              <div>
                ...
                <div className="home-story-images" aria-label="Costa Rica trip inspiration">
                  {HOME_STORY_IMAGES.map((image) => image.activity && (
                    <a
                    ...
                    >
                      <img src={image.src} alt={image.activity.title} loading="lazy" decoding="async" />
