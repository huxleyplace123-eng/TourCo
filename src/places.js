...
export const deals = [
  ...
  { id: "d11", title: "Green-season pricing", where: "TicoWild approved partners", type: "Seasonal", tag: "tour", photo: IMG("photo-1552733407-5d5c46c3bb3b"), save: "Up to 20%", price: null, code: null, detail: "May–Nov: lower tour prices, 30–40% cheaper stays, lush jungle, far fewer crowds.", expires: "May–Nov" },
...
export const freeThings = [
  ...
  { id: "f6", title: "Waterfall swimming holes", detail: "Many jungle waterfalls have free natural pools at the base — ask a local (or Rico) for the quiet ones.", cost: "Free", photo: IMG("photo-1620658927695-c33df6fb8130") },
...
export const moneyTips = [
  ...
  { id: "m4", tip: "Book through TicoWild", detail: "Published experiences come only from approved partners, and availability is confirmed before you go." },
