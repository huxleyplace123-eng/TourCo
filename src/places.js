...
// `img` maps to an activity category so each card shows a fitting real photo.
export const deals = [
  { id: "d1", title: "15% off tours, cars, hotels & transfers", where: "Costa Rica-wide", type: "Promo code", tag: "tour", img: "Ziplining", save: "Up to 15%", price: null, code: "CRGDISCOUNT", detail: "One code, no blackout dates — adventure tours, rental cars, lodging & private shuttles, all year.", expires: "No blackout dates", featured: true },
  { id: "d2", title: "Los Cañones Canopy + Hot Springs combo", where: "La Fortuna · Arenal", type: "Combo", tag: "tour", img: "Ziplining", save: "3-in-1", price: "$90", code: null, detail: "Canopy zipline + Los Lagos hot springs + water slides — one of La Fortuna's best-value days.", expires: "Daily" },
  { id: "d3", title: "Save $11/adult on Sky Adventures zipline", where: "Sky Adventures · Arenal", type: "Discount", tag: "tour", img: "Ziplining", save: "$11 off", price: null, code: null, detail: "High-adrenaline zipline through the canopy — save $11 adult / $10 student / $9 child, no booking fees.", expires: "Ongoing" },
  { id: "d4", title: "20% off Nauyaca & Manuel Antonio tours", where: "Paddle 9 · Central Pacific", type: "Promo code", tag: "tour", img: "Waterfall Adventures", save: "20% off", price: null, code: "PARADISE", detail: "Full-day waterfall tours, Nauyaca Waterfall, and Manuel Antonio Park guided tours.", expires: "Ongoing" },
  { id: "d5", title: "Sunset Sails catamaran — save $5/person", where: "Manuel Antonio", type: "Discount", tag: "tour", img: "Catamaran Cruises", save: "$5 off", price: null, code: null, detail: "Fresh mahi-mahi cooked on board + complimentary cocktails. $5+ off morning, $3+ off afternoon sails.", expires: "Ongoing" },
  { id: "d6", title: "Kids 0–4 sail free", where: "Planet Dolphin · Manuel Antonio", type: "Family", tag: "tour", img: "Catamaran Cruises", save: "Kids free", price: null, code: null, detail: "Little ones 0–4 ride the catamaran free (small transport fee). Great family day on the water.", expires: "Year-round" },
  { id: "d7", title: "Hot springs pass (no zipline needed)", where: "Los Lagos · La Fortuna", type: "Deal", tag: "tour", img: "Waterfall Adventures", save: "From", price: "$28", code: null, detail: "Not into ziplining? Grab just the hot springs + water-slide pass and still soak in Arenal.", expires: "Daily" },
  { id: "d8", title: "5% off ATV in Uvita", where: "Jungle ATV · Uvita", type: "Promo code", tag: "tour", img: "ATV Tours", save: "5% / rider", price: null, code: "CR_Surf_Travel", detail: "5% off per rider on the backcountry ATV expedition through jungle & river crossings.", expires: "Ongoing" },
  { id: "d9", title: "10–20% off car rental + free extras", where: "Adobe Rent-a-Car", type: "Promo code", tag: "transport", img: "Private Transportation", save: "10–20%", price: null, code: "SURF", detail: "Plus free 2nd driver, car seats, surf racks & hotel delivery. Tip: a car beats an SUV for cost.", expires: "Ongoing" },
  { id: "d10", title: "5% off shuttles, buses & ferries", where: "Bookaway", type: "Promo code", tag: "transport", img: "Private Transportation", save: "5% off", price: null, code: "PARADISE5", detail: "5% off shared shuttle transfers, buses and ferries countrywide.", expires: "Ongoing" },
  { id: "d11", title: "Green-season pricing", where: "TicoWild vetted operators", type: "Seasonal", tag: "tour", img: "Wildlife Night Tours", save: "Up to 20%", price: null, code: null, detail: "May–Nov: lower tour prices, 30–40% cheaper stays, lush jungle, far fewer crowds.", expires: "May–Nov" },
  { id: "d12", title: "Sunset 2-for-1 drinks", where: "El Lagarto · Manuel Antonio", type: "Happy hour", tag: "food", img: null, barTag: "sunset", save: "2-for-1", price: null, code: null, detail: "Two-for-one cocktails at sunset with ocean views. Just show up.", expires: "Daily at sunset" },
  { id: "d13", title: "Half-price Imperials", where: "Sharky's · Tamarindo", type: "Happy hour", tag: "food", img: null, barTag: "deal", save: "50% off", price: null, code: null, detail: "Half-price Imperial beers, 4–6pm every day.", expires: "Daily 4–6pm" },
  { id: "d14", title: "Casado at a local soda", where: "Sodas countrywide", type: "Local price", tag: "food", img: null, barTag: "local", save: "$5–8", price: "$5–8", code: null, detail: "A full traditional plate for $5–8 at family sodas vs. $15–30 at tourist restaurants.", expires: "Everyday" },
];
