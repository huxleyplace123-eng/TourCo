...
export const deals = [
  { id: "d1", title: "15% off tours, cars, hotels & transfers", where: "Costa Rica-wide", type: "Promo code", tag: "tour", photo: IMG("photo-1518259102261-b40117eabbc9"), save: "Up to 15%", price: null, code: "CRGDISCOUNT", detail: "One code, no blackout dates — adventure tours, rental cars, lodging & private shuttles, all year.", expires: "No blackout dates", featured: true },
